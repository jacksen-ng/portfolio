const en = {
    ...
    experience: {
        ...
        internshipKatitasName: "KATITAS Co.,Ltd",
        ...
        internshipGenieeName: "Geniee, Inc",
        internshipText2: "Development of a calendar application, improving UI/UX.",
        internshipGenieePrize: "Top 5 Finalist🏅",
        techUsed: "Tech Stack",
        activitiesTitle: "Activities 🚀",

        shiftAgentTitle: "AI Shift Management Agent 'Shift Agent' - Google Cloud AI Hackathon",
        shiftAgentText: "Developed an autonomous AI shift management agent for the Google Cloud AI Hackathon 2.0. Utilizing Gemini and LangChain, this project goes beyond simple automated scheduling by implementing a loop where the AI repeatedly 'evaluates' and 'corrects' its own draft schedules. This allows for continuous quality improvement while satisfying complex constraints like staffing and labor costs. The backend was built on a Domain-Driven Design (DDD) architecture, ensuring a highly scalable and extensible system capable of handling complex business logic.",
        shiftAgentDetail: "- Autonomous shift optimization through an evaluation/correction loop powered by Gemini and LangChain.\n- Maintainable and scalable backend design based on DDD architecture.\n- Practical cloud-native development leveraging a suite of Google Cloud services, including Cloud SQL and Cloud Run.",
        viewArticle: "View Article",

        geekHackathon: "Hackathon Project – Geek CAMP Hackathon 2025 Vol.4",
        geekPrize: "Effort Prize Winner🏅",
        geekPeriod: "May 2025 – June 2025",
        geekText: "Participated in a creative AI hackathon and co-developed a unique cooking web app that generates fictional recipes using Gemini API based on fridge ingredients.",
        geekDetail: "- Developed frontend UI using Next.js and Tailwind CSS\n- Integrated Gemini's text & image generation APIs\n- Contributed to idea pitch, UX planning, and team presentation\n- Won the 'Effort Prize' among 20 teams",
        ...
        scholarshipTitle: "Scholarships & Awards 🏆",
